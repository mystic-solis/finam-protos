...
class MetricDescriptor(_message.Message):
    ...
    class MetricDescriptorMetadata(_message.Message):
        ...
        def __init__(self, launch_stage: _Optional[_Union[_launch_stage_pb2.LaunchStage, str]] = ..., sample_period: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ..., ingest_delay: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ..., time_series_resource_hierarchy_level: _Optional[_Iterable[_Union[MetricDescriptor.MetricDescriptorMetadata.TimeSeriesResourceHierarchyLevel, str]]] = ...) -> None: ...
